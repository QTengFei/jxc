<template>
    <div>
        <el-row style="margin-top: 120px">
            <h3 style="text-align: center;margin-bottom: 4px">不同工地材料价格对比</h3>
        ...
        <div id="container2" style="width: 370px;height: 450px;margin:0 auto;"></div>
    </div>

</template>

<script>
    import contaUrl from "../../public/js/contaUrl";let echarts = require('echarts/lib/echarts')
    import qs from 'qs'
    // 引入柱状图组件
    ...
    export default {
        ...
        methods:{
            search() {
                ...
                this.$axios.get(contaUrl.contaUrl + '/report/price_compare',{
                    params:{
                        start:this.value1,
                        end:this.value2,
                        siteList:this.value3,
                        material_id:this.value4,
                    },
                    ...
                    const arr = Array.from(this.prices.data)
